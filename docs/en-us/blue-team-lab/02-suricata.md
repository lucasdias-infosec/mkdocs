...
Because the environment is virtualized (VirtualBox), proper configuration was required to ensure Suricata monitors the correct network interfaces in promiscuous mode.
